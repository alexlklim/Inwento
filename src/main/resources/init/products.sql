...
INSERT IGNORE INTO products (is_active, created, updated, title, description, price, bar_code, rfid_code,
                             created_by_id, receiver,
                             kst_id, asset_status_id, unit_id, type_id, subtype_id,
                             producer, supplier, is_scrapping,
                             branch_id, mpk_id,
                             longitude, latitude)
VALUES
    (true, NOW(), NOW(), 'My Product2', 'It is a very good laptop',4000.00,'INVff123ee', '1f2f345678',  @user_id,  'Tetiana Klimenko',
     1, 2, 4, 1, 1, 'producer1', 'supplier1', false,
     1, 1, 40.7128, -74.0060);
