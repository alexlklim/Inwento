...
public class CompanyService {
    ...
    public Map<String, Object> getInfoAboutCompany(List<String> fields) {
        ...
        return CompanyMapper.toDTOWithCustomFields(
                ...
                fields == null ? UtilCompany.getAll() : fields);
    }
    ...
    public void updateCompany(Map<String, Object> updates, Long userId) throws LabelSizeIsIncorrectException {
        ...
        updates.forEach((key, value) -> {
            switch (key) {
                ...
                case UtilCompany.BARCODE_LENGTH: company.setBarCodeLength((Integer) value); break;
                case UtilCompany.BARCODE_LENGTH_MAX: company.setBarCodeLengthMax((Integer) value); break;
                case UtilCompany.BARCODE_LENGTH_MIN: company.setBarCodeLengthMin((Integer) value); break;
                case UtilCompany.BARCODE_PREFIX: company.setBarCodePrefix((String) value); break;
                case UtilCompany.BARCODE_SUFFIX: company.setBarCodeSuffix((String) value); break;
                case UtilCompany.BARCODE_POSTFIX: company.setBarCodePostfix((String) value); break;
                default: break;
            }
        });
